 ...
 * <ul>
 *   <li>{@link asamcc.impl.FilesImpl#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilesImpl extends MinimalEObjectImpl.Container implements Files {
    ...
    protected EClass eStaticClass() {
        return Container_catalogPackage.Literals.FILES;
    }
    ...
    public EList<String> getFile() {
        if (file == null) {
            file = new EDataTypeUniqueEList<String>(String.class, this, Container_catalogPackage.FILES__FILE);
        }
        return file;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Container_catalogPackage.FILES__FILE:
                return getFile();
        }
