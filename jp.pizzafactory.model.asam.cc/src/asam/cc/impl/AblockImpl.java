...
public class AblockImpl extends MinimalEObjectImpl.Container implements Ablock {
    ...
    public Files getFiles() {
        if (files != null && files.eIsProxy()) {
            ...
            if (files != oldFiles) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContainerCatalogPackage.ABLOCK__FILES, oldFiles, files));
            }
        }
        return files;
    }
    ...
    public void setFiles(Files newFiles) {
        ...
        files = newFiles;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ContainerCatalogPackage.ABLOCK__FILES, oldFiles, files));
    }
